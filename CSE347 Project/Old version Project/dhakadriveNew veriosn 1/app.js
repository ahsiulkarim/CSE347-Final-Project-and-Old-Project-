document.addEventListener('DOMContentLoaded', () => {
   ...
   // In app.js, inside the signupForm event listener...
// This replaces the old localStorage logic with a fetch call.
...
if (signupForm) {
    signupForm.addEventListener('submit', async (e) => {
        ...
        const name = document.getElementById('name').value;
        const email = document.getElementById('email').value;
        const mobile = document.getElementById('mobile').value; // <-- GET MOBILE
        const password = document.getElementById('password').value;
        ...
        try {
            ...
            if (!response.ok) {
                // If server returns an error (e.g., user exists), show it
